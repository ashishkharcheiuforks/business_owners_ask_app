...
public class BasicRegisterActivity extends AppCompatActivity {
    ...
    private TextView tv_already_hav_an_account;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_already_hav_an_account = findViewById(R.id.tv_already_hav_an_account);
        ...
        tv_already_hav_an_account.setOnClickListener(new View.OnClickListener() {
            @Override
