...
//        AlertDialog.Builder builder = new AlertDialog.Builder(MealDetailActivity.this);
//        builder.setTitle("Start Newwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww Tray?");
//        builder.setMessage("You are ordering mealllllllllllllllllllllllllllllllllllllllllll from another restaurant. Would you like to clean the current tray?");
//        builder.setPositiveButton("Cancel", null);
//        builder.setNegativeButton("Yes", new DialogInterface.OnClickListener() {
//            @Override
//            public void onClick(DialogInterface dialog, int which) {
